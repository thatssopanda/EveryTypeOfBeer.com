...
<head> 
	...
	<!--[if lt IE 9]> <script src="<?=base_url('assets/js/html5shiv.js')?>"></script> 
	<script src="<?=base_url('assets/js/respond.min.js')?>"></script> <![endif]--> 
	<link rel="shortcut icon" href="<?=base_url('assets/images/ico/favicon.png')?>"> 
				...
				<div class="col-sm-6">
					...
					<div class="tab-content">
						<div class="tab-pane fade in active" id="about">
							<div class="media">
								<img class="pull-left media-object" src="<?=base_url('assets/images/about-us/about.jpg')?>" alt="about us"> 
						...
						<div class="tab-pane fade" id="mission">
							<div class="media">
								<img class="pull-left media-object" src="<?=base_url('assets/images/about-us/mission.jpg')?>" alt="Mission"> 
								<div class="media-body">
						...
						<div class="tab-pane fade" id="community">
							<div class="media">
								<img class="pull-left media-object" src="<?=base_url('assets/images/about-us/community.jpg')?>" alt="Community"> 
								<div class="media-body">
						...
						<div class="row item active">
							<div class="col-sm-6 col-md-3">
								<div class="single-member">
									<img src="<?=base_url('assets/images/our-team/member1.jpg')?>" alt="team member" />
									<h4>William Hurt</h4>
							...
							<div class="col-sm-6 col-md-3">
								<div class="single-member">
									<img src="<?=base_url('assets/images/our-team/member2.jpg')?>" alt="team member" />
							...
							<div class="col-sm-6 col-md-3">
								<div class="single-member">
									<img src="<?=base_url('assets/images/our-team/member3.jpg')?>" alt="team member" />
									<h4>Paul Johnson</h4>
							...
							<div class="col-sm-6 col-md-3">
								<div class="single-member">
									<img src="<?=base_url('assets/images/our-team/member4.jpg')?>" alt="team member" />
									<h4>John Richerds</h4>
		...
		<section id="portfolio">
			<div class="container">
					...
					<div class="col-sm-3 col-xs-12 portfolio-item html">
						<div class="view efffect">
							<div class="portfolio-image">
								<img src="<?=base_url('assets/images/portfolio/1.jpg')?>" alt=""></div> 
				...
				<div class="col-sm-3 col-xs-12 portfolio-item html">
					<div class="view efffect">
						...
						<div class="mask text-center">
							...
							<h4>Lorem ipsum dolor sit amet consectetur</h4>
							<a href="#"><i class="fa fa-link"></i></a>
							<a href="<?=base_url('assets/images/portfolio/big-item.jpg')?>" data-gallery="prettyPhoto"><i class="fa fa-search-plus"></i></a>
						</div>
					</div>
				</div>
				<div class="col-sm-3 col-xs-12 portfolio-item joomla">
					<div class="view efffect">
						<div class="portfolio-image">
							<img src="<?=base_url('assets/images/portfolio/8.jpg')?>" alt=""></div> 
							<div class="mask text-center">
								<h3>Novel</h3>
								<h4>Lorem ipsum dolor sit amet consectetur</h4>
								<a href="#"><i class="fa fa-link"></i></a>
					...
					<div class="col-sm-3 col-xs-12 portfolio-item wordpress">
						<div class="view efffect">
							<div class="portfolio-image">
								<img src="<?=base_url('assets/images/portfolio/10.jpg')?>" alt=""></div> 
								<div class="mask text-center">
									<h3>Novel</h3>
									<h4>Lorem ipsum dolor sit amet consectetur</h4>
									<a href="#"><i class="fa fa-link"></i></a>
						...
						<div class="col-sm-3 col-xs-12 portfolio-item joomla">
							<div class="view efffect">
								<div class="portfolio-image">
									<img src="<?=base_url('assets/images/portfolio/11.jpg')?>" alt=""></div> 
									<div class="mask text-center">
										<h3>Novel</h3>
										<h4>Lorem ipsum dolor sit amet consectetur</h4>
										<a href="#"><i class="fa fa-link"></i></a>
										<a href="<?=base_url('assets/images/portfolio/big-item3.jpg')?>" data-gallery="prettyPhoto"><i class="fa fa-search-plus"></i></a>
									</div>
								</div>
							</div>
							<div class="col-sm-3 col-xs-12 portfolio-item megento">
								<div class="view efffect">
									<div class="portfolio-image">
										<img src="<?=base_url('assets/images/portfolio/12.jpg')?>" alt=""></div> 
										<div class="mask text-center">
											<h3>Novel</h3>
											<h4>Lorem ipsum dolor sit amet consectetur</h4>
											<a href="#"><i class="fa fa-link"></i></a>
											<a href="<?=base_url('assets/images/portfolio/big-item4.jpg')?>" data-gallery="prettyPhoto"><i class="fa fa-search-plus"></i></a>
										</div>
									</div>
								</div>
							</div>
									...
									<div class="carousel-inner">
										<div class="item active">
											<div class="single-client">
												<div class="media">
													<img class="pull-left" src="<?=base_url('assets/images/clients/client1.jpg')?>" alt="">
													<div class="media-body">
										...
										<div class="item">
											<div class="single-client">
												<div class="media">
													<img class="pull-left" src="<?=base_url('assets/images/clients/client3.jpg')?>" alt="">
													<div class="media-body">
														<blockquote><p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer posuere erat a ante. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer posuere erat a ante.</p><small>Someone famous in Source Title</small><a href="">www.yourwebsite.com</a></blockquote>
													</div>
												</div>
										...
										<div class="item">
											<div class="single-client">
												<div class="media">
													<img class="pull-left" src="<?=base_url('assets/images/clients/client2.jpg')?>" alt="">
													<div class="media-body">
														<blockquote><p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer posuere erat a ante. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer posuere erat a ante.</p><small>Someone famous in Source Title</small><a href="">www.yourwebsite.com</a></blockquote>
													</div>
												</div>
							...
							<div class="row">
								<div class="col-sm-4">
									<div class="single-blog">
										<img src="<?=base_url('assets/images/blog/1.jpg')?>" alt="" />
										...
										<div class="modal-dialog">
											<div class="modal-content">
												<div class="modal-body">
													...
													<img src="<?=base_url('assets/images/blog/3.jpg')?>" alt="" />
													<h2>Lorem ipsum dolor sit amet</h2>
								...
								<div class="col-sm-4">
									<div class="single-blog">
										<img src="<?=base_url('assets/images/blog/2.jpg')?>" alt="" />
										<h2>Lorem ipsum dolor sit amet</h2>
										<ul class="post-meta">
											<li><i class="fa fa-pencil-square-o"></i><strong> Posted By:</strong> John</li>
											<li><i class="fa fa-clock-o"></i><strong> Posted On:</strong> Apr 15 2014</li>
